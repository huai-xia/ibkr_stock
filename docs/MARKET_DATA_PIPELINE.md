...
> 📖 算法详解见 [盘中异常检测算法详解](04-analysis/intraday-anomaly-detection.md)
...
| 检测项 | 框架 | 算法 | 触发 |
|--------|:--:|------|------|
| 短线波动 | 3min | ATR 短期 + 价格速率 | 波动扩大 > 3x 正常 |
| 短期趋势确认 | 5min | 均线排列 + MACD | 多头/空头排列 |
| 支撑阻力突破 | 15min | 开盘区间 + 前日高低 | 突破 + 量确认 |
| 中期趋势确认 | 30min | SMA20 方向 + ADX | ADX > 25 + 均线倾斜 |
| 多框架共振 | 1+3+5+15+30min | 五框架同向 + 量放大 | 强信号 |
