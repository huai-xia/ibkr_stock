...
| 检测项 | 算法 | 数据需求 | 触发 |
|--------|------|:--:|------|
| **⚡ 瞬间暴跌** | 5分钟 Z-Score | 5快照 | Z < -3σ |
| **⚡ 瞬间暴涨** | 5分钟 Z-Score | 5快照 | Z > +3σ |
| **📉 快速下跌** | 10分钟 ROC | 10快照 | 跌 > 2% |
| **📈 快速上涨** | 10分钟 ROC | 10快照 | 涨 > 2% |
| **波动率异常** | 20分钟快照标准差 | 20快照 | σ > 日常3倍 |
| **夜盘异动** | 20分钟变化率 | 20快照 | 涨跌 > 3% |
| **盘前跳变** | 最近价 vs 昨收 | 1快照 | 偏差 > 3% |
| **盘前趋势** | 线性回归斜率 | 60快照 | > 0.05%/分钟 |
| **放量异常** | 夜盘量 vs 近5日均夜盘量 | 累计 | > 5x |
