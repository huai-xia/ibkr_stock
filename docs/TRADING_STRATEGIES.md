...
|------|----------|:--:|------|:--:|
| **均值回归** | 涨多卖，跌多买 | 短线 | 布林带/RSI/Z-Score | ✅ MDP |
| **动量交易** | 强者恒强 | 短线 | 均线金叉/ROC | ✅ builtin/ |
| **趋势跟踪** | 顺势，截亏让利润跑 | 中/长线 | MA交叉/ADX/通道突破 | ⬜ |
| **突破交易** | 关键位突破跟进 | 短/中线 | 开盘区间/前高突破 | ⬜ |
| **事件驱动** | 财报/并购/政策→波动 | 短/中线 | 新闻情感+波动率 | ⬜ |
| **价值投资** | 买低估等回归 | 长线 | PE/PB/ROE/DCF | ⬜ |
| **成长投资** | 买高增长享复利 | 长线 | 营收增速/毛利率 | ⬜ |
| **分红策略** | 稳定现金流 | 长线 | 股息率/派息历史 | ⬜ |
| **统计套利** | 配对协整→价差收敛 | 短/中线 | 协整检验/卡尔曼滤波 | ⬜ |
| **网格交易** | 区间低买高卖 | 短/中线 | 布林带/ATR网格 | ⬜ |
...
| 策略 | 数据需求 | 说明 |
|------|------|------|
| 趋势跟踪 | 日线+MA+ADX | 已有数据基础 |
| 波段交易 | 日线+布林+RSI | 已有数据基础 |
| 事件驱动 | 新闻API | 已有 news/ 模块 |
